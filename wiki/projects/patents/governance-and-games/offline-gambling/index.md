...
This branch covers the offline deterministic gaming seam: how hierarchical key derivation and time-based entropy support a game system that can remain deterministic without being online.
The provisional patent status is now historical context; the page is useful as an informing artifact for governance, determinism, and custody language.
