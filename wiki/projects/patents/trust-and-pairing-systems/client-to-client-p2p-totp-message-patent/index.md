# Client-to-client P2P TOTP + Message Patent

Parent lineage: `Patents` / `Trust and Pairing Systems`

This branch covers the client-to-client mutual-authentication and message-exchange patent pair. The draft and the expanded complete version read as one stable messaging seam.

## Current Shape

- 2 live files.
- 1 draft provisional patent manuscript.
- 1 expanded complete provisional patent manuscript.
...
1. Keep the draft and complete patent manuscripts together.
2. Split only if a separate messaging or handshake seam appears.
