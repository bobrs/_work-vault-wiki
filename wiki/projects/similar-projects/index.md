...
- [Cognitive Runtime](cognitive-runtime/index.md)
- [Context and Reflection](context-and-reflection/index.md)
- [Temporal and Topological Models](temporal-and-topological-models/index.md)
- [Protocol and Sovereignty](protocol-and-sovereignty/index.md)
- [Glyphframe and Compression](glyphframe-and-compression/index.md)
...
2. Split again only if one of the five tracks develops another durable seam.
