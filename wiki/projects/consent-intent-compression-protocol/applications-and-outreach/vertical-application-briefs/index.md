# Vertical Application Briefs

Parent lineage: `Consent–Intent Compression Protocol (CICP)` / `Applications and Outreach`
...
1. Keep the vertical briefs together.
2. Split only if one vertical grows into its own durable sub-branch.
