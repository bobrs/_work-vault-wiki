...
That makes it the first applied layer in the CICP implementation stack.
...
1. Keep the pairing and field access set together.
2. Split only if a distinct access sub-branch appears.
