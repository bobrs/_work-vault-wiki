...
- 1 research and preregistration track.
- 2 nested support pages organize the set.

## Nested Support Pages

- [Site Variants](site-variants/index.md)
- [Research and Preregistration](research-and-preregistration/index.md)

## Representative Files

- [Consentful Cybernetics homepage](<../../../artifacts/intake-archive/20260623__consentful-cybernetics-site-variants-intake/20260603__CONSENTFUL-CYBERNETICS__HOMEPAGE__V0-3__CAT-BIT__INDEX.html>)
...
2. Add more support material only if it clearly belongs to one of those two rails.
3. Split again only if the site family develops another durable seam.
