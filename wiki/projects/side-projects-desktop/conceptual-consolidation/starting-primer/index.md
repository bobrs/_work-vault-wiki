...
This sub-branch gathers the primer documents and is best read as an entry point to the SCT and loop stack.
...
This is orientation material, not canonical content. Keep it linked back to the Semantic Collapse Theory lineage.

## Next Actions

1. Keep the primer pages visible as entry points.
2. Do not promote this folder into a new canonical branch unless it develops new content.
