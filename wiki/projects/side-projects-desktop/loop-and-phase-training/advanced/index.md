...
This branch reads like a deep training stack rather than a single document set. The internal folders are coherent enough to stand on their own now.

## Next Actions

1. Keep the six nested lineage pages stable.
2. Split again only if one of the nested pages develops a second seam.
