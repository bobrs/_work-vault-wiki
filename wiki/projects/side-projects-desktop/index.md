...
This branch is the desktop-sized source vault for side projects, reference materials, mirror sets, and duplicate candidates.
...
- [Reference - Stored Crystals](reference-stored-crystals/index.md)
...
1. Keep the linked canonical pages stable for the duplicate families.
2. Split again only when a folder develops a second durable seam.
