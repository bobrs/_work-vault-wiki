...
- 1 new nested lineage page is split below; the other two seams already have canonical wiki pages.

## Nested Lineage Pages

- [Dialogica](dialogica/index.md)

## Already Linked Elsewhere

- [Abracadabra Protocol](../../patents/abracadabra-protocol/index.md)
...
1. Keep the linked canonical pages stable.
2. Split `Dialogica` further only if the media or protocol tracks become separate seams.
