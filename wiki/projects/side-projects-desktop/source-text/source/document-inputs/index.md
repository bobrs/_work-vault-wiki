...
This branch collects the DOCX source inputs under `Source`.
...
This is the input seam inside `Source`.

## Next Actions

1. Keep the source inputs together.
2. Split only if another input seam appears.
