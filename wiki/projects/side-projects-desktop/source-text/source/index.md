...
This is the DOCX source bundle under `Source text`.

## Current Shape

- 6 files, including paired DOCX inputs and generated analysis markdown.
- 2 nested lineage pages organize the set.

## Nested Lineage Pages

- [Document Inputs](document-inputs/index.md)
- [Analysis Outputs](analysis-outputs/index.md)
...
The source bundle is a paired input/analysis set. The DOCX originals and analysis markdown now sit on their own pages.
