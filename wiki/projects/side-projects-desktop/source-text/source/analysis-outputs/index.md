...
This branch collects the generated analysis markdown under `Source`.
...
This is the analysis-output seam inside `Source`.

## Next Actions

1. Keep the analysis outputs together.
2. Split only if a second analysis seam appears.
