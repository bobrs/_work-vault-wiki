# Safety and Stable Loop Language

This branch covers the safety-facing loop language and the companion safety-seeking folder.

## Current Shape

- 5 files total.
- 1 published HTML page.
- 1 nested HTML page is split below.
- 1 auxiliary safety-seeking folder remains empty except for metadata.
...
2. Ignore `Safety Seeking` unless it gains actual content.
