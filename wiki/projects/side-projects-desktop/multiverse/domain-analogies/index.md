...
This branch collects the discipline-specific multiverse analogies.
...
This is the analogy seam inside Multiverse: each document maps the consent-resonance frame into a different domain.

## Next Actions

1. Keep the domain analogies together.
2. Split only if one domain becomes a separate branch.
