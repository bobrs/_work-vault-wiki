# Interpretation, Logic, and Therapy

Parent lineage: `Semantic Collapse Theory` / `Affective Interfaces`

This cluster covers neural interpretation, loop-based logic synthesis, and therapeutic modeling.

## Current Shape

- 3 interpretation, logic, and therapy documents.
...
2. Split only if a distinct downstream seam appears.
