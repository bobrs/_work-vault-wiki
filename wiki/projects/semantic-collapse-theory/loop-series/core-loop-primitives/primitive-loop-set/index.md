...
This cluster covers the five core loop forms that define the primitive SCT loop family.

## Current Shape

- 5 primitive loop documents.
...
2. Split only if a new primitive loop appears.
