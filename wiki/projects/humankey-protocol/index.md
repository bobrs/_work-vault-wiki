...
This branch collects the HumanKey trust-authentication family in the current intake.

## Current Shape

- 5 protocol and submission documents.
...
2. Split again only if the presentation or protocol tracks develop another durable seam.
