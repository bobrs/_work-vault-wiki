...
The current corpus already supports recurring attractors and stabilized concept pages. Use the attractor pages when entering by meaning, and use this index when you want the recurring concept layer that survives across branches.

## Attractor Bridges

- [Witness](../attractors/witness/index.md) -> [Witnessing](witnessing/index.md), [Governance Diad](governance-diad/index.md)
- [Consent](../attractors/consent/index.md) -> [Intent-Consent](intent-consent/index.md), [Consent Physics](consent-physics/index.md), [AI Did Not Break Consent](ai-did-not-break-consent/index.md)
...
Do not add concept pages for one-off motifs that have not yet stabilized across the corpus.
