...
Source role: human navigation surface  
Layer: semantic wiki interface

This page offers short paths through the wiki for different kinds of readers.

## I am an AI grounding a conversation
...
## I want to understand witness

Start with:

- [Witness](../attractors/witness/index.md)
- [Source Roles](/wiki/source-roles/index.html)
- [Duplicate Review](/wiki/duplicate-review.html)
- [Missing Files](/wiki/missing-files.html)
- [AI Answer Contracts](../ai-answer-contracts/index.md)

## I want to understand loops
...
## I want to understand provenance

Start with:

- [Provenance](../attractors/provenance/index.md)
- [Source Roles](/wiki/source-roles/index.html)
- [Incoming Review](/wiki/incoming-review.html)
- [Duplicate Review](/wiki/duplicate-review.html)
- [Raw Vault](/vault/index.html)
...
## I want to help maintain the vault

Start with:

- [README](/readme.html)
- [WIKI](/wiki-guide.html)
- [AI Context](/AI_CONTEXT.md)
- [Source Roles](/wiki/source-roles/index.html)
- [Incoming Review](/wiki/incoming-review.html)
- [Duplicate Review](/wiki/duplicate-review.html)
