...
Start with [AI Context](/AI_CONTEXT.md) and the public [AI Entry Surface](/ai/index.html).

This repository is markdown-first. The wiki pages are the semantic layer, the manifests are the machine-readable layer, and the artifacts tree preserves source material and lineage.

Rules:

- Prefer local wiki pages when they exist.
- Prefer standard-named source copies over inbound originals when a source file is needed.
